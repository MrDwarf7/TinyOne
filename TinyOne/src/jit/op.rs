...
impl JitBuiltin {
    ...
    pub(crate) fn arg_count(self) -> usize {
        match self {
            ...
            Self::Len | Self::ArrayPop | Self::VecClear | Self::Alloc | Self::Load | Self::Free => {
                1
            }
...
impl JitOp {
    pub(crate) fn compare_slot_int_jump_if_zero(
        slot: usize,
        value: i64,
        op: Op,
        target: usize,
    ...
    pub(crate) fn listing(self) -> String {
        match self {
            ...
            Self::CompareSlotIntJumpIfZero(operands) => format!(
                "slot.cmp.{}.i.jz {} {} {}",
            ...
            Self::CompareSlotIntJumpIfZeroHot(operands) => format!(
                "slot.cmp.{}.i.jz.hot {} {} {}",
                operands.comparison().name().to_ascii_lowercase(),
                operands.slot(),
                operands.value(),
            ...
            Self::MapGetAddSlots(slots) => format!(
                "map.get.add.slots {} {} {}",
                slots.total_slot(),
                slots.map_slot(),
                slots.key_slot()
            ),
            Self::MapSetMulSlots(slots) => format!(
                "map.set.mul.slots {} {} {} {} {}",
                slots.map_slot(),
                slots.key_slot(),
                slots.value_slot(),
    ...
    pub(crate) fn profile_name(self) -> &'static str {
        match self {
            ...
            Self::BuiltinDirect(builtin) => match builtin {
    ...
    pub(crate) fn operand_stack_traffic(self) -> (usize, usize) {
        match self {
            ...
            Self::MakeArray(count) | Self::MakeStruct(_, count) | Self::MakeEnum(_, count) => {
                (1, count)
            }
            Self::SetIndex => (0, 3),
            Self::SetField(_) => (0, 2),
...
mod tests {
    ...
    fn lowers_collection_and_cell_builtins_to_direct_ops() {
        ...
        assert!(matches!(
            JitOp::from_instr(Instr::new(Op::Builtin, array, 2)).unwrap(),
            JitOp::Builtin(_, _)
        ));
    }
}
